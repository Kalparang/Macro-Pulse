...
- `PAGES_REPORT_URL`: 텔레그램/디스코드 요약 하단에 붙일 GitHub Pages 리포트 URL
- 공개 URL이므로 `Settings > Secrets and variables > Actions > Variables`에 repository variable로 등록하는 것을 권장합니다.
- 예: `https://your-github-username.github.io/your-repository/`
